...
#define IDM_IO_PHYS_TO_VIRT(x) (void __iomem *)(((x & 0xFFF00000) == (int)get_iproc_idm_base_phys(0))?  get_iproc_idm_base(0) + x - get_iproc_idm_base_phys(0) : get_iproc_idm_base(1) + x - get_iproc_idm_base_phys(1))
#else
#define IDM_IO_PHYS_TO_VIRT(x) (void __iomem *)(get_iproc_idm_base(0) + x - get_iproc_idm_base_phys(0))
#endif /* (defined (CONFIG_MACH_GH) || defined (CONFIG_MACH_SB2) || defined (CONFIG_MACH_GH2)) */
